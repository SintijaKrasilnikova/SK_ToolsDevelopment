...
void Game::Update(DX::StepTimer const& timer)
{
	...
	m_displayChunk.m_terrainEffect->SetView(thisCamera->GetCameraView());
...
void Game::Render()
{
	//Get variables from the Camera class
	DirectX::SimpleMath::Vector3 m_camPosition = thisCamera->GetCameraPosition();
	m_view = thisCamera->GetCameraView();
